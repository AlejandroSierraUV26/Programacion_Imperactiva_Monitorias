...
class TestDatosArchivoTXT(unittest.TestCase):
    def test_datos_txt(self):
        self.assertTrue(verificar_datos_txt(fr"Test Final\datos.txt","python"))
        self.assertTrue(verificar_datos_txt(fr"Test Final\datos.txt","java"))
        self.assertTrue(verificar_datos_txt(fr"Test Final\datos.txt","c++"))
        self.assertTrue(verificar_datos_txt(fr"Test Final\datos.txt","php"))
        self.assertTrue(verificar_datos_txt(fr"Test Final\datos.txt","ruby"))
